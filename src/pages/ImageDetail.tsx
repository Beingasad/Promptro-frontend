...
import { ArrowLeft, Bookmark, Copy, Check, Heart, Eye, Flame, Minus, Tag, Share2, GalleryVerticalEnd, Download } from 'lucide-react';
...
import { AnimatedCategoryQualityPill } from '../components/AnimatedCategoryQualityPill';
    ...
    <>
      ...
      <div className="absolute bottom-3 left-3 right-3 md:bottom-4 md:left-4 md:right-4 flex flex-wrap items-center justify-between gap-2 md:gap-3">
        ...
        <div className="relative flex shrink-0">
          <AnimatedCategoryQualityPill prompt={prompt} />
        </div>
      </div>
    </>
  );
      ...
      <section className="shrink-0 flex flex-col gap-3">
        <div className="flex items-center justify-between gap-3 px-1">
          <div className="flex items-center gap-3">
            <SparkleIcon className="h-6 w-6 shrink-0 drop-shadow-[0_0_10px_rgba(168,85,247,0.7)]" variant="purple" />
        ...
        {/* Remix Prompt in AI Style Mixer (Directly below the main positive prompt card) */}
