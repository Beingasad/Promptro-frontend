  ...
  return (
    <div className="min-h-screen pb-32 sm:pb-20 px-4 sm:px-6">
      ...
      <AnimatePresence>
        {createOpen && (
          <div className="fixed inset-0 z-[300] flex items-center justify-center p-4">
            <motion.button type="button" className="fixed inset-0 bg-white/8 dark:bg-white/3 backdrop-blur-md w-full h-full border-none outline-none" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} onClick={() => setCreateOpen(false)} />
            <motion.div
