      ...
      <AnimatePresence>
        ...
        {(isExplore || isHome) && activeDropdown === 'category' && (
          <motion.div
            ...
            className={`absolute top-full mt-2.5 z-50 w-52 max-h-[300px] overflow-y-auto hide-scrollbar rounded-2xl border border-white/80 bg-white/94 p-2.5 shadow-[0_24px_50px_rgba(72,56,118,0.24)] backdrop-blur-3xl dark:border-white/10 dark:bg-[#14111f]/94 ${
        ...
        {isExplore && activeDropdown === 'sort' && (
          <motion.div
            ...
            exit={{ opacity: 0, y: 10, scale: 0.95 }}
            transition={{ duration: 0.2, ease: [0.16, 1, 0.3, 1] }}
            className="absolute right-2 top-full mt-2.5 z-50 w-52 rounded-2xl border border-white/80 bg-white/94 p-2.5 shadow-[0_24px_50px_rgba(72,56,118,0.24)] backdrop-blur-3xl dark:border-white/10 dark:bg-[#14111f]/94"
          >
