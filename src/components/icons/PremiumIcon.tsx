...
export const PremiumIcon = ({ className = "", strokeWidth = 2 }: { className?: string, strokeWidth?: number | string }) => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    <g id="SVGRepo_iconCarrier"> 
      ...
      <path d="M9 7.5L8.5 8.25V8.25C8.20344 8.69484 8.23479 9.28176 8.57706 9.69247L10.5 12" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"></path> 
    </g>
  </svg>
);
