        ...
        >
          ...
          <div className="relative h-[150px] w-40 shrink-0 flex items-center justify-end z-10">
            ...
            {banner.secondary_image && (
              <div className="absolute z-10 -left-6 top-3 h-[136px] w-[94px] rounded-2xl overflow-hidden border-2 border-white dark:border-white/15 shadow-[0_12px_24px_rgba(0,0,0,0.12)] opacity-100 group-hover:scale-105 group-hover:-translate-x-1 group-hover:-rotate-18 transform -rotate-12 transition-all duration-500">
                <img 
