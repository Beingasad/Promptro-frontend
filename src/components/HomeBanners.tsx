              ...
              >
                ...
                <div className="relative z-10 flex items-center justify-between mb-4 pb-2.5 border-b border-white/15">
                  <div className="min-w-0 pr-2">
                    <h3 className="text-sm font-black uppercase tracking-wider text-white truncate max-w-[20rem] drop-shadow-[0_1px_1.5px_rgba(0,0,0,0.45)]">{selectedBannerForModal.title}</h3>
