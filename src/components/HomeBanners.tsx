      ...
      {processedBanners.slice(0, 2).map((banner: any, index) => (
        ...
        >
          ...
          <div className="relative z-10 flex flex-col gap-2.5 max-w-[48%]">
            ...
            <div className="mt-3 flex items-center gap-1.5 text-[12px] font-black text-primary dark:text-white bg-primary/10 dark:bg-white/10 border border-primary/20 dark:border-white/15 px-5 py-2.5 rounded-full w-fit backdrop-blur-md shadow-[0_8px_32px_rgba(31,38,135,0.02)] transition-all duration-300 group-hover:bg-gradient-to-r group-hover:from-[#7437ff] group-hover:via-[#dd4bd2] group-hover:to-[#ff642d] group-hover:text-white group-hover:border-transparent group-hover:scale-[1.05] group-hover:shadow-[0_6px_20px_rgba(116,55,255,0.35)] active:scale-95">
