      ...
      {isVisible && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 z-[110] w-full rounded-t-3xl border-t border-white/40 bg-white/70 px-6 py-5 shadow-[0_-10px_36px_rgba(72,56,118,0.08)] backdrop-blur-3xl dark:border-white/10 dark:bg-[#0d0b14]/70 dark:shadow-[0_-12px_52px_rgba(0,0,0,0.4)] md:px-12 md:py-4.5"
          >
