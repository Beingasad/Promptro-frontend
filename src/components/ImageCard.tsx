    ...
    <>
      ...
      <div className={`absolute z-10 transition-transform duration-300 group-hover:-translate-y-0.5 ${
        ...
        <button 
          ...
          className="rounded-full bg-gradient-to-r from-[#6d4dec]/90 to-[#ff6a3d]/90 px-2.5 py-[3px] text-[9px] font-bold uppercase tracking-wider text-white transition-transform active:scale-95 md:px-3 md:py-[3.5px] md:text-[10px] shadow-sm whitespace-nowrap opacity-90 backdrop-blur-[4px]"
